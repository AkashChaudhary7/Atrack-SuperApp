...
export const LockScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-800 flex flex-col justify-between p-6 select-none font-sans">
      {/* Upper Brand Info */}
      <div className="flex flex-col items-center mt-12">
        <div className="w-16 h-16 bg-gradient-to-tr from-indigo-500 to-indigo-700 rounded-2xl flex items-center justify-center shadow-md shadow-indigo-200 mb-3">
          <Shield className="w-9 h-9 text-white" />
        </div>
        <h1 className="text-3xl font-display font-black tracking-tight text-slate-900 uppercase">Atrack</h1>
        <p className="text-[10px] text-emerald-600 font-mono font-bold uppercase mt-1 tracking-wider">SECURE OFF-GRID SUITE • PRIVATE</p>
      </div>
