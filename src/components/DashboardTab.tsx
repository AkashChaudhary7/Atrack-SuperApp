      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-1">
            ...
            <span className="text-[10px] font-black text-slate-450 tracking-wider font-mono uppercase block">Compact Telemetry Suites</span>
          </div>
          <span className="text-[8px] font-mono text-indigo-500 font-bold bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-100 uppercase">Live Vault</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <motion.div 
            whileHover={{ scale: 1.015 }}
            onClick={() => setActiveTab("expenses")}
            className="bg-white border border-slate-150 hover:border-amber-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-amber-500/10 text-amber-600 rounded-lg group-hover:bg-amber-500/20 transition-all">
                <Wallet className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Expenses</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">₹{totalExpenses.toFixed(0)}</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-emerald-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-emerald-500/10 text-emerald-600 rounded-lg group-hover:bg-emerald-500/20 transition-all">
                <ClipboardList className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Bills</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{pendingBillsCount} Pending</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-rose-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-rose-500/10 text-rose-600 rounded-lg group-hover:bg-rose-500/20 transition-all">
                <Flame className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Habits</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{averageStreak}d Streak</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-pink-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-pink-500/10 text-pink-600 rounded-lg group-hover:bg-pink-500/20 transition-all">
                <HeartHandshake className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Retention</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{currentRetentionStreak}d Clean</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-indigo-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-indigo-500/10 text-indigo-600 rounded-lg group-hover:bg-indigo-500/20 transition-all">
                <Dumbbell className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Workouts</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">Gym & Kegel</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-teal-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-teal-500/10 text-teal-600 rounded-lg group-hover:bg-teal-500/20 transition-all">
                <Pill className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Medicines</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{activeMedicinesCount} Active</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-150 hover:border-purple-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-purple-500/10 text-purple-600 rounded-lg group-hover:bg-purple-500/20 transition-all">
                <Scale className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Weight</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{currentWeight} kg</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>

          {/* Card 8: STUDY PLANNER */}
          <motion.div 
            whileHover={{ scale: 1.015 }}
            onClick={() => setActiveTab("study")}
            className="bg-white border border-slate-150 hover:border-blue-500/60 rounded-xl p-2.5 flex items-center justify-between cursor-pointer group transition-all"
          >
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-blue-500/10 text-blue-600 rounded-lg group-hover:bg-blue-500/20 transition-all">
                <GraduationCap className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="text-[8.5px] font-bold text-slate-400 uppercase tracking-tight block">Study</span>
                <span className="text-xs font-black text-slate-800 font-mono block leading-tight">{totalStudyMinutes} mins</span>
              </div>
            </div>
            <ArrowRight className="w-3 h-3 text-slate-350 group-hover:translate-x-0.5 transition-transform" />
          </motion.div>
